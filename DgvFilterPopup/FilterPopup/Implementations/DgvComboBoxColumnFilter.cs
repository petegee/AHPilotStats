...
namespace DgvFilterPopup
{
    ...
    public partial class DgvComboBoxColumnFilter : DgvBaseColumnFilter
    {
        ...
        /// 
        /// </summary>
        public string EscapedHeaderText
        {
            get { return "[" + this.DataGridViewColumn.DataPropertyName + "]"; }
        }
        ...
        protected override void OnFilterInitializing(object sender, CancelEventArgs e)
        {
            ...
            {
                comboBoxValue.ValueMember = EscapedHeaderText;
        ...
        public void RefreshValues()
        {
            if (!(this.DataGridViewColumn is DataGridViewComboBoxColumn))
            {
                ...
                DistinctDataTable.DefaultView.Sort = EscapedHeaderText;
        ...
        protected override void OnFilterExpressionBuilding(object sender, CancelEventArgs e)
        {
            ...
            if (comboBoxOperator.Text == "= Ø") ResultFilterExpression = GetNullCondition(EscapedHeaderText);
            if (comboBoxOperator.Text == "<> Ø") ResultFilterExpression = GetNotNullCondition(EscapedHeaderText);
            ...
            object FilterValue = comboBoxValue.Text; //comboBoxValue.SelectedValue;
            ...
            if (ColumnDataType == typeof(string))
            {
                ...
                ResultFilterExpression = EscapedHeaderText + " " + comboBoxOperator.Text + "'" + EscapedFilterValue + "'";
            ...
            else
            {
                ...
                if (FormattedValue != "")
                {
                    ResultFilterExpression = EscapedHeaderText + " " + comboBoxOperator.Text + FormattedValue;
                    ResultFilterCaption += "\n" + comboBoxOperator.Text + " " + comboBoxValue.Text;
                }
